...
public:
    vector<vector<int>> generate(int numRows) {
        ...
        for(int i = 0 ;i < numRows ; i++ )
        {
            ...
            for(int j = 1;j < i;j++){  //  as all the vector elements are ini to 1 we know 
                                       //  first and last element is 1 so we just traverse 
                                       //  from 1 to j < i as vector is resized to i+1
